import {
  assertToBe,
  assertThrow,
} from "../../../../dependencies/asserts/assert.js";
...
describe("isNotEqualTests", () => {
  ...
  // если длины не одинаковы, наша функция заканчивается и выводит true
  test("количество символов одинаково, но не равны", () => {
...
describe("isMoreOrEqualTests", () => {
  ...
  test("несоответствие типа первого аргумента приводит к ЛОЖЬ", () => {
    ...
    assertThrow(
      () => isMoreOrEqual(undefined, "2"),
      "argument must be type of string"
    );
    assertThrow(
      () => isMoreOrEqual(null, "2"),
      "argument must be type of string"
    );
  });
});
...
describe("isLessOrEqualTests", () => {
  ...
  test("несоответствие типа первого аргумента приводит к ЛОЖЬ", () => {
    ...
    assertThrow(
      () => isLessOrEqual(undefined, "2"),
      "argument must be type of string"
    );
    assertThrow(
      () => isLessOrEqual(null, "2"),
      "argument must be type of string"
    );
  });
});
